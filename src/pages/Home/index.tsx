    ...
    <>
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
              ...
              <Typewriter
                texts={[
                  { text: "Hi, I'm ", className: "" },
                  {
                    text: "Orkhan Aslanov",
                    className:
                      "bg-linear-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent",
                  },
          ...
          {/* Right Side - Image */}
          <div className="relative lg:w-160 w-full">
            <img
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <div className="pt-4">
                ...
                >
                  <span className="relative z-20 bg-linear-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">
                    DOWNLOAD MY CV
                  </span>
                </a>
              </div>
