  ...
  return (
    <div className="bg-[#212121] rounded-2xl overflow-hidden">
      ...
      <div className="lg:p-8 px-3 py-6">
        ...
        <div>
          <p className="text-[#878e99] text-xs mb-4 uppercase tracking-wider">
            FIND WITH ME
          </p>
          <div className="flex gap-3">
            <a
              href="https://github.com/AslanovOrkhan"
              className="bg-[#1a1a1a] w-14 h-14 flex items-center justify-center rounded-lg hover:bg-linear-to-r hover:from-cyan-400 hover:to-emerald-400 transition-all duration-300 group"
            >
              <svg
